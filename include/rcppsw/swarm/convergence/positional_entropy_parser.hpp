...
#ifndef INCLUDE_RCPPSW_SWARM_CONVERGENCE_POSITIONAL_ENTROPY_PARSER_HPP_
#define INCLUDE_RCPPSW_SWARM_CONVERGENCE_POSITIONAL_ENTROPY_PARSER_HPP_
...
#endif /* INCLUDE_RCPPSW_SWARM_CONVERGENCE_POSITIONAL_ENTROPY_PARSER_HPP_ */
