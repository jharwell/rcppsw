...
#ifndef INCLUDE_RCPPSW_TA_SIGMOID_SEL_XML_PARSER_HPP_
#define INCLUDE_RCPPSW_TA_SIGMOID_SEL_XML_PARSER_HPP_
...
#endif /* INCLUDE_RCPPSW_TA_SIGMOID_SEL_XML_PARSER_HPP_ */
