/**
 * @file task_alloc_xml__parser.hpp
 *
...
#ifndef INCLUDE_RCPPSW_TA_TASK_ALLOC_XML_PARSER_HPP_
#define INCLUDE_RCPPSW_TA_TASK_ALLOC_XML_PARSER_HPP_
...
#include "rcppsw/ta/exec_estimates_parser.hpp"
#include "rcppsw/ta/src_sigmoid_sel_xml_parser.hpp"
#include "rcppsw/ta/task_alloc_params.hpp"
#include "rcppsw/ta/task_partition_xml_parser.hpp"
...
class task_alloc_xml_parser : public rcppsw::params::xml_param_parser {
 public:
  ...
  std::shared_ptr<task_alloc_params> parse_results(void) const {
    return m_params;
  }
 ...
 private:
  ...
  /* clang-format off */
  bool                               m_parsed{false};
  std::shared_ptr<task_alloc_params> m_params{nullptr};
...
#endif /* INCLUDE_RCPPSW_TA_TASK_ALLOC_XML_PARSER_HPP_ */
