...
#ifndef INCLUDE_RCPPSW_TA_PARTITION_PROBABILITY_HPP_
#define INCLUDE_RCPPSW_TA_PARTITION_PROBABILITY_HPP_
...
#endif /* INCLUDE_RCPPSW_TA_PARTITION_PROBABILITY_HPP_ */
