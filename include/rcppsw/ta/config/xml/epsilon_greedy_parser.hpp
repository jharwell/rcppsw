...
#ifndef INCLUDE_RCPPSW_TA_CONFIG_XML_EPSILON_GREEDY_PARSER_HPP_
#define INCLUDE_RCPPSW_TA_CONFIG_XML_EPSILON_GREEDY_PARSER_HPP_
...
#endif /* INCLUDE_RCPPSW_TA_CONFIG_XML_EPSILON_GREEDY_PARSER_HPP_ */
