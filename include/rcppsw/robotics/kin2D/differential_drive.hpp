...
#ifndef INCLUDE_RCPPSW_ROBOTICS_KIN2D_DIFFERENTIAL_DRIVE_HPP_
#define INCLUDE_RCPPSW_ROBOTICS_KIN2D_DIFFERENTIAL_DRIVE_HPP_

/*******************************************************************************
 * Includes
 ******************************************************************************/
#include "rcppsw/common/common.hpp"
#include "rcppsw/robotics/kin2D/model.hpp"
 ...
 * \ref kFSMDrive
 */
class differential_drive : public kin2D::model,
 ...
 public:
  ...
  /**
   * @brief Initialize differential drive kin model.
   *
  ...
  */
   ...
   * @return \ref status_t.
   */
  status_t curvature_drive(const kin::twist& twist, bool hard_turn);
...
#endif /* INCLUDE_RCPPSW_ROBOTICS_KIN2D_DIFFERENTIAL_DRIVE_HPP_ */
