...
#ifndef INCLUDE_RCPPSW_ROBOTICS_STEERING2D_POLAR_FORCE_XML_PARSER_HPP_
#define INCLUDE_RCPPSW_ROBOTICS_STEERING2D_POLAR_FORCE_XML_PARSER_HPP_
...
class polar_force_xml_parser : public rcppsw::params::xml_param_parser {
 public:
  ...
  std::shared_ptr<polar_force_params> parse_results(void) const {
    return m_params;
  }
 ...
 private:
  /* clang-format off */
  bool                                m_parsed{false};
  std::shared_ptr<polar_force_params> m_params{nullptr};
  /* clang-format on */
};

NS_END(steering2D, robotics, rcppsw);

#endif /* INCLUDE_RCPPSW_ROBOTICS_STEERING2D_POLAR_FORCE_XML_PARSER_HPP_ */
