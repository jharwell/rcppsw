...
#ifndef INCLUDE_RCPPSW_MATH_CONFIG_SIGMOID_CONFIG_HPP_
#define INCLUDE_RCPPSW_MATH_CONFIG_SIGMOID_CONFIG_HPP_
...
#endif /* INCLUDE_RCPPSW_MATH_CONFIG_SIGMOID_CONFIG_HPP_ */
