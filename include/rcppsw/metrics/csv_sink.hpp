 ...
 * classes choose.
 */
class csv_sink : public rmetrics::base_metrics_sink,
 ...
 public:
  ...
  void initialize(const rmetrics::base_metrics_data* data) override;
  metrics_write_status flush(const rmetrics::base_metrics_data* data,
 ...
 protected:
  ...
  virtual std::list<std::string> csv_header_cols(
      const rmetrics::base_metrics_data* data) const = 0;
 ...
 private:
   ...
   */
  void csv_header_write(const rmetrics::base_metrics_data* data);
