 ...
 * Class Constants
 ******************************************************************************/
constexpr char steering_force2D_xml_parser::kXMLRoot[];

/*******************************************************************************
 * Member Functions
 ******************************************************************************/
void steering_force2D_xml_parser::parse(const argos::TConfigurationNode& node) {
  ticpp::Element knode =
...
void steering_force2D_xml_parser::show(std::ostream& stream) const {
  stream << build_header() << m_avoidance << m_arrival << m_wander << m_polar
         << std::endl
         << build_footer();
} /* show() */

__pure bool steering_force2D_xml_parser::validate(void) const {
