...
executable_task::executable_task(const std::string& name,
    ...
    : logical_task(name),
      ...
      m_interface_times(kMAX_INTERFACES, types::timestep(0)),
      m_last_interface_times(kMAX_INTERFACES, types::timestep(0)),
      m_interface_start_times(kMAX_INTERFACES, types::timestep(0)),
