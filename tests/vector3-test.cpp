 ...
 * Test Cases
 ******************************************************************************/
CATCH_TEST_CASE("Init test", "[vector3]") {
  /* default constructor */
  math::vector3i t0;
  ...
  math::vector3i t1(1, 2, 3);
  CATCH_REQUIRE(1 == t1.x());
  CATCH_REQUIRE(2 == t1.y());
  CATCH_REQUIRE(3 == t1.z());
}

CATCH_TEST_CASE("Length test", "[vector3]") {
  math::vector3d t0(2, 2, 2);
  math::vector3d t1(4, 4, 4);
...
CATCH_TEST_CASE("Operator test", "[vector3]") {
  math::vector3d t0(0.0, 0.0, 0.0);
  math::vector3d t1(0, 1.5, 1);
  math::vector3d t2(1, 1, 1);
  ...
  CATCH_REQUIRE(t2 - t1 == math::vector3d(1, -0.5, 0));
  CATCH_REQUIRE(t2 + t1 == math::vector3d(1, 2.5, 2));
  CATCH_REQUIRE(t0 * 3 == t0);
  CATCH_REQUIRE(t2 / 2 == math::vector3d(0.5, 0.5, 0.5));
  CATCH_REQUIRE(t0 < t1);
  CATCH_REQUIRE(!(t1 < t0));
  CATCH_REQUIRE(t1 < t2);
}
